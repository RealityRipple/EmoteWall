...
* `display`  
  ...
  * `access`  
    *A bitwise flag representing which users' messages show up on the emote wall.*  
    ...
    |   Flag  | Meaning                  | Twitch | YouTube | Kick | Trovo | Variations     |
    | ------: | :----------------------- | :----: | :-----: | :--: | :---: | :------------- |
    | `0x800` | broadcaster              |   T    |   YT    |  K   |  TL   |                |
    | `0x400` | moderator badge          |   T    |   YT    |  K   |  TL   |                |
    | `0x200` | founder badge            |   T    |         |  K   |       |                |
    | `0x100` | vip badge                |   T    |         |  K   |  TL   |                |
    | `0x080` | artist badge             |   T    |         |      |       |                |
    | `0x040` | tier 3 subscriber badge  |   T    |         |  K   |  TL   | K: OG          |
    | `0x020` | tier 2 subscriber badge  |   T    |         |      |  TL   |                |
    | `0x010` | tier 1 subscriber badge  |   T    |   YT    |  K   |  TL   | YT: Member     |
    | `0x008` | verified user            |        |   YT    |  K   |       |                |
    | `0x004` | cheer badge              |   T    |         |  K   |  TL   | Cheer Messages |
    | `0x002` | follower                 |   T    |   YT    |  K   |  TL   | YT: Subscriber |
    | `0x001` | stranger                 |   T    |   YT    |  K   |  TL   |                |
