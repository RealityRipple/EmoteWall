...
A home-made emote wall for Twitch.TV, Kick, YouTube, and Trovo Livestreams, supporting animated Twitch emotes, BetterTTV, FrankerFaceZ, 7TV, and Emojis! Kappagen command and event triggers are also available, with advanced configuration capabilities.
...
The order between services can be re-arranged in the configuration, but first-party (Twitch, YouTube, Kick, or Trovo) is always first.  
